...
namespace CareerCloud.Pocos
{
    ...
    public class SecurityLoginPoco:IPoco
    {
        ...
        public virtual ICollection<ApplicantProfilePoco> ApplicantProfil { get; set; }
        public virtual ICollection<SecurityLoginsLogPoco> Security_logs { get; set; }
        public virtual ICollection<SecurityLoginsRolePoco> Security_Logins_roles { get; set; }
    }
}
