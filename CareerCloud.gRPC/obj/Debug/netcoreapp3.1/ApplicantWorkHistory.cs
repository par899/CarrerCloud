...
namespace CareerCloud.gRPC.Protos {
    ...
    static ApplicantWorkHistoryReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "b3VkLmdSUEMaG2dvb2dsZS9wcm90b2J1Zi9lbXB0eS5wcm90byIiChRJZFJl",
            "cXVlc3RXb3JrSGlzdG9yeRIKCgJJZBgBIAEoCSLsAQobQXBwbGljYW50V29y",
            "a0hpc3RvcnlQYXlsb2FkEgoKAklkGAEgASgJEhEKCUFwcGxpY2FudBgCIAEo",
            "CRITCgtDb21wYW55TmFtZRgDIAEoCRITCgtDb3VudHJ5Q29kZRgEIAEoCRIQ",
            "CghMb2NhdGlvbhgFIAEoCRIQCghKb2JUaXRsZRgGIAEoCRIWCg5Kb2JEZXNj",
            "cmlwdGlvbhgHIAEoCRISCgpTdGFydE1vbnRoGAggASgREhEKCVN0YXJ0WWVh",
            "chgJIAEoBRIQCghFbmRNb250aBgKIAEoBRIPCgdFbmRZZWFyGAsgASgFMrgD",
            "ChRBcHBsaWNhbnRXb3JrSGlzdG9yeRJxChhSZWFkQXBwbGljYW50V29ya0hp",
            "c3RvcnkSJi5DYXJlZXJDbG91ZC5nUlBDLklkUmVxdWVzdFdvcmtIaXN0b3J5",
            "Gi0uQ2FyZWVyQ2xvdWQuZ1JQQy5BcHBsaWNhbnRXb3JrSGlzdG9yeVBheWxv",
            "YWQSYwoaQ3JlYXRlQXBwbGljYW50V29ya0hpc3RvcnkSLS5DYXJlZXJDbG91",
            "ZC5nUlBDLkFwcGxpY2FudFdvcmtIaXN0b3J5UGF5bG9hZBoWLmdvb2dsZS5w",
            "cm90b2J1Zi5FbXB0eRJjChpVcGRhdGVBcHBsaWNhbnRXb3JrSGlzdG9yeRIt",
            "LkNhcmVlckNsb3VkLmdSUEMuQXBwbGljYW50V29ya0hpc3RvcnlQYXlsb2Fk",
            "GhYuZ29vZ2xlLnByb3RvYnVmLkVtcHR5EmMKGkRlbGV0ZUFwcGxpY2FudFdv",
            "cmtIaXN0b3J5Ei0uQ2FyZWVyQ2xvdWQuZ1JQQy5BcHBsaWNhbnRXb3JrSGlz",
            "dG9yeVBheWxvYWQaFi5nb29nbGUucHJvdG9idWYuRW1wdHlCGqoCF0NhcmVl",
  ...
  public sealed partial class ApplicantWorkHistoryPayload : pb::IMessage<ApplicantWorkHistoryPayload> {
    ...
    public int CalculateSize() {
      ...
      if (StartMonth != 0) {
        size += 1 + pb::CodedOutputStream.ComputeSInt32Size(StartMonth);
      }
      if (StartYear != 0) {
